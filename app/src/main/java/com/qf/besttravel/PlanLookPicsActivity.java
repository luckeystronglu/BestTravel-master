 ...
 */
public class PlanLookPicsActivity extends BaseActivity {
    ...
    public static class PicsVpAdapter extends PagerAdapter {
        ...
        private List<DesInfoEntity.DataBean.SectionsBean.ModelsBean.ContentBean> piclist;

        public PicsVpAdapter(Context context,List<DesInfoEntity.DataBean.SectionsBean.ModelsBean.ContentBean> piclist) {
